# rock-paper-scissors
11-5-23
Doing a simple rock, paper, scissors game in javascript. I will start coding it so it is playable in the browser console, but it will be revisited later and adding graphical UI with buttons and text. 

Assignment:
1. Start new git repo-done
